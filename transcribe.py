...
authenticator = IAMAuthenticator('HzcH41nwRLoC-BH7uHAd1L5Bj4djxIWL3CljC0h7IO0l')
tts = TextToSpeechV1(authenticator=authenticator)
tts.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/e9f8d118-ddd4-4d94-b393-4cb426bd0cd2')
...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        with open('Text.txt', 'w') as tex:
            tex.writelines(data['results'][0]['alternatives'][0]['transcript'])
